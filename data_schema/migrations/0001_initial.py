    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field_type', models.CharField(max_length=32, choices=[(b'STRING', b'STRING'), (b'INT', b'INT'), (b'FLOAT', b'FLOAT'), (b'DATETIME', b'DATETIME'), (b'BOOLEAN', b'BOOLEAN'), (b'DATE', b'DATE')])),
