...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FieldSchema.display_name'
        db.add_column(u'data_schema_fieldschema', 'display_name',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=64, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FieldSchema.display_name'
        db.delete_column(u'data_schema_fieldschema', 'display_name')
